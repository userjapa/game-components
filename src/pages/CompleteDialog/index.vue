...
<script>
import DialogAnswers from '../../components/DialogAnswers'
...
export default {
  ...
  methods: {
    save(exercise) {
      ...
      else this.$store.commit('dialog/setExercise', exercise)
    },
    ...
    edit(question, id) {
      this.$store.commit('dialog/setToUpdate', id)
      this.question = question
    },
    update(question) {
      this.$store.commit('dialog/update', question)
      this.cancel()
    },
    remove(id) {
    ...
    cancel() {
      ...
      this.$store.commit('dialog/setToUpdate', null)
    }
  },
  computed: {
    isToUpdate() {
      return this.$store.getters['dialog/isToUpdate']
    }
  },
  components: {
    DialogAnswers
  ...
  mounted () {
    this.exercise = this.$store.getters['dialog/getExercise']
  }
}
</script>
